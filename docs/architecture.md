...
| 应用 | ApplicationPlugin, MenuPlugin（含 MenuRole 角色菜单项）, TrayPlugin, ScreenPlugin, LogPlugin |
...
| 移动端 | BiometricPlugin, NfcPlugin, BarcodeScannerPlugin, HapticsPlugin, AndroidRuntimePlugin（仅 Android） |
