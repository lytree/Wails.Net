using ScreenType = Wails.Net.Application.Screens.Screen;
...
namespace Wails.Net.Plugins.Screen;
...
public class ScreenPlugin : IPlugin
{
    ...
    public void Configure(IPluginContext context)
    {
        ...
        // === 屏幕查询 ===
        commands.MapCommand("screen.getAll", (Func<ICommandContext, ScreenType[]>)(ctx =>
            GetAppOrThrow(ctx).GetScreens()));

        commands.MapCommand("screen.getPrimary", (Func<ICommandContext, ScreenType?>)(ctx =>
    ...
    private static WailsApplication GetAppOrThrow(ICommandContext ctx)
    {
