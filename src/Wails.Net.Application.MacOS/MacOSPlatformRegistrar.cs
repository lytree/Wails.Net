...
/// <summary>
/// macOS 平台注册器，通过 <c>[ModuleInitializer]</c> 在模块加载时自动向
/// <see cref="PlatformFactory"/> 注册 macOS 平台的创建委托。
/// </summary>
/// <remarks>
...
internal static class MacOSPlatformRegistrar
{
    ...
    {
        PlatformFactory.RegisterPlatformApp("macos", static options => new MacOSPlatformApp(options));
        PlatformFactory.RegisterClipboard("macos", static () => new MacOSClipboard());
    }
}
