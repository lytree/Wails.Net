...
- **插件系统**：内置 41 个插件（37 桌面 + 4 移动端），借鉴 Tauri v2 权限模型与 Capability 自动加载
...
参考 [Demo 项目](examples/Wails.Net.Demo/) 可查看 P1 全部能力的端到端示例，[构建打包指南](docs/development/build-and-pack.md) 涵盖从开发到分发的完整流程。
